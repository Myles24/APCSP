...
wn.addshape(apple_image) # Make the screen aware of the new filea
...
#
#apple = trtl.Turtle()
#appleLetter = '' #apple's letter. It starts as blank
...
def draw_apple(index):
  ...
  wn.tracer(False)
  appleList[index].setx(rand.randint(-175,175)) #reset the apple position
  appleList[index].sety(rand.randint(-25,100)) #reset the apple position
